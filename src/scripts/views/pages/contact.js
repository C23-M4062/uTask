...
<!-- Email Icon Section End -->
      ...
      <div class="row" data-aos="fade-up" data-aos-delay="200">
        <div class="team-card" data-aos="fade-up" data-aos-delay="500">
          <img src="img/ui-ux.jpg" alt="Front-end Developer" class="team-card-img" />
          <h3 class="team-card-tittle">FRONT-END DEVELOPER</h3>
          <p>M. Fahril</p>
        </div>
        <div class="team-card" data-aos="fade-up" data-aos-delay="500">
          <img src="img/front-end.jpg" alt="Front-end Developer" class="team-card-img" />
          <h3 class="team-card-tittle">FRONT-END DEVELOPER</h3>
          <p>Si Gede Ngurah Chandra Adi Natha</p>
        </div>
        <div class="team-card" data-aos="fade-up" data-aos-delay="500">
          <img src="img/back-end.jpg" alt="Front-end Developer" class="team-card-img" />
          <h3 class="team-card-tittle">FRONT-END DEVELOPER</h3>
          <p>Saddam Rasyad Abdillah</p>
        </div>
        <div class="team-card" data-aos="fade-up" data-aos-delay="500">
          <img src="img/data-analysis.jpg" alt="Back-end Developer" class="team-card-img" />
